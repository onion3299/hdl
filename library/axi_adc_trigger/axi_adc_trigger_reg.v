...
module axi_adc_trigger_reg (
 ...
 // bus interface
  ...
  wire    [ 9:0]  config_i_trigger;

  // internal registers

  reg     [31:0]  up_version = 32'h00010000;
  reg     [31:0]  up_scratch = 32'h0;
  reg     [ 9:0]  up_config_i_trigger = 10'h0;
  ...
  reg     [16:0]  up_trigger_out_control = 32'h0;
  reg     [31:0]  up_fifo_depth = 32'h0;
  reg     [31:0]  up_trigger_delay = 32'h0;
  reg             up_triggered = 1'h0;
  reg             up_streaming = 1'h0;

  assign low_level  = config_i_trigger[1:0];
  assign high_level = config_i_trigger[3:2];
  assign any_edge   = config_i_trigger[5:4];
  assign rise_edge  = config_i_trigger[7:6];
  assign fall_edge  = config_i_trigger[9:8];
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      if ((up_wreq == 1'b1) && (up_waddr[4:0] == 5'h3)) begin
        io_selection <= up_wdata[3:0];
      end
      if ((up_wreq == 1'b1) && (up_waddr[4:0] == 5'h4)) begin
        up_config_i_trigger <= up_wdata[9:0];
      end
    ...
    if (up_rstn == 0) begin
      ...
      if (up_rreq == 1'b1) begin
        case (up_raddr[4:0])
          ...
          5'h3: up_rdata <= {28'h0,io_selection};
          5'h4: up_rdata <= {22'h0,up_config_i_trigger};
